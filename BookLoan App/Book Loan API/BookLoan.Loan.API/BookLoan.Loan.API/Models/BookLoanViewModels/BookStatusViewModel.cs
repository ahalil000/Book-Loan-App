...
namespace BookLoan.Models
{
    public class BookStatusViewModel: BookViewModel
    {
        ...
        public string DateLoanedUSFormattedString
        {
            get { return (DateLoaned.Year == 1) ? "N/A" : DateLoaned.ToString("MM/dd/yyyy"); }
        }

        public string DateDueUSFormattedString
        {
            get { return (DateDue.Year == 1) ? "N/A" : DateDue.ToString("MM/dd/yyyy"); }
        }

        public string DateReturnUSFormattedString
        {
            get { return (DateReturn.Year == 1) ? "N/A" : DateReturn.ToString("MM/dd/yyyy"); }
        }
